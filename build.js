...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-KTBDSR1GK7"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-KTBDSR1GK7');
    </script>
    <meta charset="UTF-8">
    ...
    <meta property="og:image" content="https://i.ibb.co/b6VTXFJ/share-Image.jpg">
    ...
    <meta name="twitter:image" content="https://i.ibb.co/b6VTXFJ/share-Image.jpg">
</head>
<body>
